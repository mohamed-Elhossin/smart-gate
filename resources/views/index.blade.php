      ...
      <div class="row">
        ...
        <div class="col-lg-7 pt-5 pt-lg-0 order-2 order-lg-1 d-flex flex-column justify-content-center">
          ...
          <p data-aos="fade-up" data-aos-delay="400">
            الأفكار المبدعه والمبتكرة هي طريقنا لبناء علاقتنا مع العميل كفريق عمل واحد بداية من العمل سوياً ثم التشغيل
      ...
      <div class="container">
        ...
        <div class="row owl-carousel owl-theme">
          ...
          <div class="card newItem">
            <img src="./assets/img/news.png" height="300" class="card-img-top" alt="...">
            <div class="card-body">
              <p class="card-title"> الاحد. 12/3
                <i class="bx bx-calendar-edit"></i> </p>
              <p class="card-text">هناك حقيقة مثبتة منذ زمن طويل وهي أن المحتوى المقروء لصفحة ما سيلهي القارئ عن
                ...
                لوريم إيبسوم لأنها تعطي توزيعاَ طبيعياَ -إلى حد ما-</p>
            </div>

          </div>

          <div class="card newItem">
            <img src="./assets/img/p5.png" height="300" class="card-img-top" alt="...">
            <div class="card-body">
              <p class="card-title"> الاحد. 12/3
                <i class="bx bx-calendar-edit"></i> </p>
              <p class="card-text">هناك حقيقة مثبتة منذ زمن طويل وهي أن المحتوى المقروء لصفحة ما سيلهي القارئ عن
          ...
          <div class="card newItem">
            <img src="./assets/img/p6.png" height="300" class="card-img-top" alt="...">
            <div class="card-body">
              <p class="card-title"> الاحد. 12/3
                <i class="bx bx-calendar-edit"></i> </p>
              <p class="card-text">هناك حقيقة مثبتة منذ زمن طويل وهي أن المحتوى المقروء لصفحة ما سيلهي القارئ عن
        ...
        <div class="row">
          <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0">
            <div class="icon-box" data-aos="fade-up" data-aos-delay="100">
              ...
              <p class="description">
                نحن قادرون علي بناء مشاريع وتطبيقات برمجية لإدارة مشاريعك من خلال فريق متخصص والعمل بكفاءة عالية
          ...
          <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0">
            <div class="icon-box" data-aos="fade-up" data-aos-delay="200">
              ...
              <p class="description">إنشاء وتصميم المواقع بالشكل الذي يتناسب مع هويتك واهدافك بشكل احترافي لتحسين الشكل
          ...
          <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0">
            <div class="icon-box" data-aos="fade-up" data-aos-delay="300">
              ...
              <p class="description">نعمل علي تحليل البيانات وبناءها والعمل علي إنشاء نظام برمجي يناسب حاجتك وإدارة
          ...
          <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0">
            <div class="icon-box" data-aos="fade-up" data-aos-delay="400">
              <div class="icon"><i class="bx bxs-mobile-vibration"></i></div>
              <h4 class="title"><a href="">تطبيقات الموبيل</a></h4>
              <p class="description">نظراً لأهمية تطبيقات الموبايل وكثرة عدد مستخدميها بشكل لا غني عنه الآن نهتم بالعمل
      ...
      <div class="container">
        ...
        <div class="row  owl-carousel owl-theme">
          ...
          <div class="card newItem">
            <img src="./assets/img/news.png" height="300" class="card-img-top" alt="...">
            <div class="card-body">
              <p class="font-weight-bold card-text"> ندوة خاصة عن مراحل إنشاء المواقع </p>
              <p class="card-title"> الاحد. 12/3
                <i class="bx bx-calendar-edit"></i> </p>
        ...
        <div class="conatiner">
          <div class="row">
            <div class="mt-3 col-xl-3 col-lg-4 col-md-6">
              <img src="./assets/img/s1.png" style="box-shadow: 10px 10px 10px gray;" class="img-fluid" alt="">
            </div>
            <div class="mt-3 col-xl-3 col-lg-4 col-md-6">
              <img src="./assets/img/s1.png" style="box-shadow: 10px 10px 10px gray;" class="img-fluid" alt="">
            </div>
          ...
          <div class="col-lg-5 col-md-12" data-aos="fade-up" data-aos-delay="300">
            <form action="forms/contact.php" method="post" role="form" class="php-email-form">
              <div class="form-group">
                ...
                <input type="text" name="name" class="form-control" id="name" placeholder=".. اكتب الاسم هنا" required>
              </div>
              <div class="form-group">
                <label for="">اختار الخدمة التي تريدها</label>
                <input type="email" class="form-control" name="email" id="email" placeholder="اختر الخدمة" required>
              </div>
              <div class="form-group"> <label for="">رقم الهاتف</label>
                <input type="text" class="form-control" name="subject" id="subject" placeholder="010222411***" required>
              </div>
              <div class="form-group"> <label for="">البريد الإلكتروني</label>
                <input type="text" class="form-control" name="subject" id="subject" placeholder="name@gmail.com"
                  required>
              </div>
